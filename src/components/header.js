...
const navigation = [
  ...
  { name: 'NFRAEI', href: '/NFRAI', current: false },
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? ' text-white underline ' : 'text-gray-300 hover:bg-green-900 hover:text-white',
            ...
            <div className="space-y-1 px-2 pb-3 pt-2 justify-center items-center">
              {navigation.map((item) => (
                <DisclosureButton
                  ...
                  href={item.href}
                  className={classNames(
                    item.current ? 'text-u text-white underline' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
